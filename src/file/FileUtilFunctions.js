 ...
 */
   ...
   export function onPluginLoad(ev)
   {
      ...
      eventbus.on(`typhonjs:util:file:list:dir:get`, getDirList);
      eventbus.on(`typhonjs:util:file:list:file:get`, getFileList);
      eventbus.on(`typhonjs:util:file:path:relative:get`, getRelativePath);
      eventbus.on(`typhonjs:util:file:url:path:dir:get`, getURLDirpath);
      eventbus.on(`typhonjs:util:file:url:path:file:get`, getURLFilepath);
      eventbus.on(`typhonjs:util:file:file:has`, hasFile);
      ...
      eventbus.on(`typhonjs:util:file:dir:walk`, walkDir);
      eventbus.on(`typhonjs:util:file:files:walk`, walkFiles);
   }
